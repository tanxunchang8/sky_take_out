...
public class ReportServiceImpl implements ReportService {
    ...
    public UserReportVO getUserStatistics(LocalDate begin, LocalDate end) {
        ...
        //存放每天的新增用户数量 select count(id) from user where creata_time < ? and create_time > ?
            ...
            for (int i = 0; i < 30; i++) {
                ...
                BusinessDataVO businessData = workspaceService
                        .getBusinessData(LocalDateTime
                                .of(date, LocalTime.MIN), LocalDateTime.of(date, LocalTime.MAX));
                //获得某一行
